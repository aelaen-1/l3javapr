    ...
    public ArrayList<UE> chargerUEs() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(FILE_PATH))) {
            ...
            while ((ligne = br.readLine()) != null) {
                ...
                //on  découpe en : Code ; Nom ; Crédits ; Mention
                            ...
                            for (String codeUnSeulPre : codesPrerequis) {
                                ...
                                for (UE objetPrerequis : ues) {
                                    if (objetPrerequis.getCode().equals(codeUnSeulPre)) {
                                        ...
                                        break; // On a trouvé le prérequis, on passe au code suivant
                                    }
                                }
                            }
                            break; // On a fini avec cette ueCible, on passe à la ligne CSV suivante
                        }
                    }
                }
            }
